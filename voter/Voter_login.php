...
if (isset($_POST['submit'])) 
{
    ...
    $sql = "select * from `non_verify_voter`where voterid='$voterid' and password=md5('".$password."')";
...
<?php
    ...
    if (isset($process)) { ?>
        <script>
            Swal.fire({
                icon: 'info',
                title: 'Verification!!',
                text: 'Your Voter-id is under verification, please wait for its approval.',
                button: 'Ok',
            }).then(
            function() {
    ...
    if (isset($reject)) { ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Rejected!!',
                text: 'Your Voter-id is rejected, please register once again with correct details.',
                button: 'Ok',
            }).then(
            function() {
                    window.location.href = "Voter_login.php";
    ...
    <div class="container">
        <form action="Voter_login.php" method="post" class="login">
            <div class="title">
                <h2>Login</h2>
            </div>
            <div class="items">
                ...
                <div class="item1">
                    ...
                    <input type="text" name="voterid" id="vid" placeholder="Enter Voter's id" required>
                </div>
                <div class="item2">
                ...
                <div class="new">
                    <p>New User?<a style="text-decoration: none" href="../voter/register.php">Register here</a>
                    <p>
                </div>
            </div>
